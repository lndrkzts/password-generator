...
parser.add_argument("-u", "--upper", action='store_true', help="Needs uppercase characters", default=True)
parser.add_argument("-lo", "--lower", action='store_true', help="Needs lowercase characters", default=True)
parser.add_argument("-n", "--number", action='store_true', help="Needs numbers", default=True)
parser.add_argument("-s", "--special", action='store_true', help="Needs specials characters", default=True)
